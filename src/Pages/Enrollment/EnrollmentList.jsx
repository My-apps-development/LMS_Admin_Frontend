...
const EnrollmentList = () => {
    ...
    const FetchEnrollmentById = async () => {
        try {
            const response = await axiosInstance.get(`https://myappsdevelopment.co.in/enrollment/singleenrollment?enrollmentid=65c9fc650cc2acf9da6191c5`)
            const data = await response.data
            console.log(data);
        } catch (error) {
    ...
    const handleEditEnrollment = async (_id) => {
        console.log(_id);
    }
        ...
        <div className="w-full">
            ...
            <div className="ml-56 mt-32 w-auto p-3 font-semibold text-gray-600">
                ...
                <div className="flex justify-between items-center p-2">
                    ...
                    <button className="p-2 border-2 border-[#B32073] bg-[#B32073] text-white hover:bg-pink-800 flex justify-center items-center gap-3 w-32" onClick={() => setIsOpen(true)}><FaPlus />Add</button>
                </div>
                                    ...
                                    return (
                                        <tr className="bg-gray-100 text-center border-b text-sm text-gray-600" key={index}>
                                            ...
                                            <td className="p-2 border-r cursor-pointer text-2xl flex justify-center items-center gap-5 font-semibold text-gray-500 ">
                                                <p onClick={()=>handleEditEnrollment(item?._id)}><CiEdit /></p>
            ...
            <div>
                <Modal
                    open={isOpen}>
                    <Box sx={style}>
                        <form className="w-full font-semibold text-gray-600 flex flex-col gap-5" onSubmit={handleSubmitEnrollment}>
                            ...
                            <div className="flex flex-col p-2 gap-3">
                                ...
                                <select name="role" id="" className="p-3 border-2 border-gray-600 rounded-lg" onChange={handleChange}>
                            ...
                            <div className="flex flex-col p-2 gap-3">
                                ...
                                <select name="courses_to_enroll" id="" className="p-3 border-2 border-gray-600 rounded-lg" onChange={handleChange}>
                                    <option value={userRole["role-1"]}>{userRole["role-1"]}</option>
                                    <option value={userRole["role-2"]}>{userRole["role-2"]}</option>
                                    <option value={userRole["role-3"]}>{userRole["role-3"]}</option>
                                </select>
                            ...
                            <div className="w-full flex justify-center items-center">
                                <button className="p-2 border-2 border-[#B32073] bg-[#B32073] text-white hover:bg-pink-800 flex justify-center items-center gap-3 w-32 rounded-lg" type="submit">Enroll Course</button>
                            </div>
                        </form>
                    </Box>
                </Modal>
