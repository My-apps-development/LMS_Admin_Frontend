...
const AddCompany = () => {
    ...
    return (
        <div>
            ...
            <div className="ml-56 mt-3 w-auto p-3 font-semibold text-gray-600" >
                <div className="w-full p-5 rounded border-2 flex flex-col gap-5">
                        ...
                        <div className={`${addCompanyOpen ? "block" : "hidden"}`}>
